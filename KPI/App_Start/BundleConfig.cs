...
namespace KPI
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new Bundle("~/bundles/jqueryval").Include("~/Scripts/jquery.validate*"));
            ...
            bundles.Add(new Bundle("~/Content/css").Include("~/Content/bootstrap-sandstone.css", "~/Content/site.css"));
        }
    }
}
