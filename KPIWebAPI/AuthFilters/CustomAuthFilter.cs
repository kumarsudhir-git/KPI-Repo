...
namespace KPIWebAPI.AuthFilters
{
    public class CustomAuthFilter : Attribute, IAuthenticationFilter
    {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            {
                if (!AuthorizationProcess.IsUserAuthorize(token, context.Request.Method.Method, menuCode))
                {
                    context.ErrorResult =  new AuthenticationFailureResult("Method Not Allowed", request);
                }
            }
